...
def build_response(prediction:PredictionResult,explanation:ExplanationResult,metadata:dict)-> APIResponse:
    ...
    modelinfo=ModelInfo(name=metadata["model_name"],version=metadata["model_version"])

    return APIResponse(prediction=prediction_response,explanation=explanation,model=modelinfo)
